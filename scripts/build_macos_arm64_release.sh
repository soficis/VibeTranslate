#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# build_macos_arm64_release.sh
#
# Builds the full macOS arm64 (Apple Silicon) portable release bundle.
# NOTE: macOS builds are primarily focused on ARM64. x64 is best-effort and untested.
#
# Equivalent of scripts/build_windows_x64_release.ps1 for macOS ARM.
#
