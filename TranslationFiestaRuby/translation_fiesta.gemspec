...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'A comprehensive Ruby application for back-translation with quality assessment and cost tracking'
  ...
  spec.add_runtime_dependency 'google-cloud-translate-v2', '~> 0.4.0'
  ...
  spec.add_runtime_dependency 'keyring', '~> 0.3.0'
